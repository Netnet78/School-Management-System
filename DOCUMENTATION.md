...
3. [Architecture (Clean Architecture)](#3-architecture-clean-architecture)
...
- `OpenCvSharp4` 4.13.0 — computer vision
- `SkiaSharp` 3.119.0 — 2D graphics
...
│  Report Generators, DTOs/Contracts           │
├─────────────────────────────────────────────┤
│         Infrastructure Layer                 │
