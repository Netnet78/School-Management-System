...
namespace School_Management.Core.Interfaces.Application
{
    ...
    public interface IAuthorizationService
    {
        ...
        Task<bool> AuthorizeAsync(object? resource, OperatorMode operatorMode, params PermissionType[] permissions);
        /// <summary>
        ...
        Task<bool> AuthorizeAsync(object? resource, PermissionType permission);
    }
}
