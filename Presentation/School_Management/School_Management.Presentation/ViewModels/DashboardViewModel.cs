...
using School_Management.Presentation.Shared.Observables;
...
namespace School_Management.Presentation.ViewModels
{
    public partial class DashboardViewModel : ObservableObject, IAsyncLoadable, IViewModel
    {
        ...
        [ObservableProperty]
        private ChartModel _studentsPerClassChart = new();

        [ObservableProperty]
        private ChartModel _genderChart = new();
        [ObservableProperty]
        ...
        [ObservableProperty]
        private ChartModel _attendanceChart = new();
        [ObservableProperty]
